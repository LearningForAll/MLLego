...
class LayerGenerator:
    ...
    def linear(self, input_tensor, output_size, activation):
    ...
    def create_stack_rnn(self, input_tensor, rnn_size, stack_size, using_only_end=False):
    ...
    def pool(self, input_tensor, pool_type, pool_size, stride_size=None, padding='VALID'):
